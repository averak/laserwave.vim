...
if &background == 'light'
  ...
  hi Normal ctermbg=8 ctermfg=252 guibg=#161821 guifg=#c6c8d1
  ...
  hi Conceal ctermbg=8 ctermfg=242 guibg=#161821 guifg=#6b7089
  hi Constant ctermfg=140 guifg=#a093c7
  hi Cursor ctermbg=252 ctermfg=8 guibg=#c6c8d1 guifg=#161821
  ...
  hi Error ctermbg=8 ctermfg=203 guibg=#161821 guifg=#e27878
  hi ErrorMsg ctermbg=8 ctermfg=203 guibg=#161821 guifg=#e27878
  hi WarningMsg ctermbg=8 ctermfg=203 guibg=#161821 guifg=#e27878
  ...
  hi Search ctermbg=216 ctermfg=8 guibg=#e4aa80 guifg=#392313
  ...
  hi StatusLine cterm=reverse ctermbg=8 ctermfg=245 gui=reverse guibg=#17171b guifg=#818596 term=reverse
  hi StatusLineTerm cterm=reverse ctermbg=8 ctermfg=245 gui=reverse guibg=#17171b guifg=#818596 term=reverse
  ...
  hi TabLineSel cterm=NONE ctermbg=8 ctermfg=252 gui=NONE guibg=#161821 guifg=#9a9ca5
  hi TermCursorNC ctermbg=242 ctermfg=8 guibg=#6b7089 guifg=#161821
  hi Title ctermfg=216 gui=NONE guifg=#e2a478
  hi Todo ctermbg=8 ctermfg=150 guibg=#45493e guifg=#b4be82
  ...
  hi WildMenu ctermbg=255 ctermfg=8 guibg=#d4d5db guifg=#17171b
  ...
  hi Sneak ctermbg=140 ctermfg=8 guibg=#a093c7 guifg=#161821
